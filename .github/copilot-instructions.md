# Copilot Instructions for notifications-service

This repository owns event-driven notification delivery (email/SMS/in-app) and PII-safe messaging behavior.
